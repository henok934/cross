...
from .import views
from .views import TicketBookingView, Workerdelet, SeeView, Activates, Activate, TicketBookingViews, Books, Totalballance,  Specific, MyDriver, Serviceupdate, DriverUpdateViewss, MyBus, ServicInsertView, UpdateTicketViews, ScDeleteViews, Scchange,  Sce, SelView, MyRoute, BusInsertView, ShowTicketsViewss,ScInsertViews, BusInsertViews, businsert, Safaricompassword, ForgotPasswordView, Boapassword, Cbepassword, Awashpassword, Telebirrpassword, ShowTicketsViews,TelebirrPaymentView, SafariPaymentView, AwashPaymentView, CbePaymentView, BoaPaymentView, ProcessPaymentView, SelectView,ChangesBusView, ChangePasswordViews, ChangesPasswordView, ChangeBusesViews, DeleteTickets, BusUpdateViewss, BusDeleteViews,CommentDeleteViews, WorkerDeleteViews, RouteDeleteViews, CityDeleteViews, About, AboutViews, AdminDeleteViews, LoginView,  BusInsert, HomeViews, BookView, GetTicketViews, CommentsView,  CityInsertView, RoutesInsertView, UrRegisterView, Workers, TicketInfoView, SelectBusView, book_ticket, RegisterView, Buse, Com, Rout, Use, Drivers, get_tickets,BusesView, GetTicketView,WorkerView, RouteView, CityView, RouteCheckView, DeleteTicketViews, DeleteTicketsView, CheckDeleteTicketView, SelectBusView, SelectView, AdminDeleteView, RouteDeleteView, BusesView, WorkerDeleteView, BusDeleteView, CityDeleteView, CommentDeleteView,UpdateBusView, ChangePasswordView, RegisterView, RootView, LogoutView, UsersView, CommentsView, RoutesView, SelectBusView, ApiView, YourApiView, RouteLookupView, ViewRoute, Routes, RouteView
