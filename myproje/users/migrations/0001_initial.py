# Generated by Django 5.1.10 on 2026-01-16 08:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('no_seats', models.IntegerField(default=45)),
                ('level', models.CharField(default='Level 1', max_length=50)),
                ('owner_sc', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='buses', to='users.sc')),
            ],
        ),
        migrations.CreateModel(
            name='Worker',
